...
const (
	HealthCheckService_Liveness_FullMethodName  = "/HealthCheckService/Liveness"
...
func (c *healthCheckServiceClient) Liveness(ctx context.Context, in *LivenessRequest, opts ...grpc.CallOption) (*LivenessResponse, error) {
	...
	err := c.cc.Invoke(ctx, HealthCheckService_Liveness_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HealthCheckService_Liveness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HealthCheckService_Liveness_FullMethodName,
	}
